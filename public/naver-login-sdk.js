!(function (t, n) {
  ...
  return (function (t) {
    ...
    function (t, n, e) {
      ...
      t.exports = { store: u, map: c, has: a, get: f, set: s, keys: l, key: h, exp: p };
    },
    function (t, n, e) {
      'use strict';
      if (e(7)) {
        var r = e(34),
          ...
          It = function (t) {
            ...
            for (
              l && a > 2 && (s = f(s, arguments[2], 2)), n = 0, e = v(c.length), i = kt(this, e);
              e > n;
              n++
            )
              i[n] = l ? s(c[n], n) : c[n];
        ...
        mt || ((B.f = Dt), (D.f = Bt)),
          u(u.S + u.F * !mt, 'Object', { getOwnPropertyDescriptor: Dt, defineProperty: Bt }),
          o(function () {
            ht.call({});
          }) &&
            (ht = pt =
          ...
          (t.exports = function (t, n, e, a) {
            ...
            x
              ? ((d = e(function (t, e, r, i) {
                  ...
                  if (S(e)) {
                    if (
                      !(e instanceof q || 'ArrayBuffer' == (a = _(e)) || 'SharedArrayBuffer' == a)
                    )
                  ...
                  for (h(t, '_d', { b: o, o: p, l: u, e: c, v: new K(o) }); l < c; ) T(t, l++);
                })),
                (w = d.prototype = E(Vt)),
                h(w, 'constructor', d))
              : (o(function () {
                ...
                ((d = e(function (t, e, r, i) {
                  ...
                  var o;
                  return S(e)
                    ? e instanceof q || 'ArrayBuffer' == (o = _(e)) || 'SharedArrayBuffer' == o
                      ? i !== undefined
                        ? new y(e, Et(r, n), i)
                        : r !== undefined
                          ? new y(e, Et(r, n))
        ...
        n = (t.exports = function (t, n, e, l, h) {
          ...
          if (o(y)) {
            for (p = c(t.length); p > x; x++)
              if ((g = n ? m(u((d = t[x]))[0], d[1]) : m(t[x])) === f || g === s) return g;
          } else
    ...
    function (t, n, e) {
      var r = e(0),
        ...
        h = (l.trim = function (t, n) {
          return (
            (t = String(i(t))), 1 & n && (t = t.replace(f, '')), 2 & n && (t = t.replace(s, '')), t
          );
        });
      t.exports = l;
    },
                  ...
                  : g && s
                    ...
                    : y && _[f] == l
                      ...
                      : v && 'function' == typeof l
                        ? o(Function.call, l)
                        : l),
              v && (((m.virtual || (m.virtual = {}))[f] = l), t & a.R && x && !x[f] && u(x, f, l)));
        };
      (a.F = 1),
        (a.G = 2),
        (a.S = 4),
    ...
    function (t, n, e) {
      ...
      t.exports = function (t, n, e, v, g, y) {
        ...
        } else (x = v.getConstructor(n, t, g, _)), u(x.prototype, e), (c.NEED = !0);
        return p(x, t), (b[t] = x), i(i.G + i.W + i.F * (x != m), b), y || v.setStrong(x, t, g), x;
      };
    },
    function (t, n, e) {
      'use strict';
    ...
    function (t, n, e) {
      ...
      t.exports = function (t, n, e, d, v, g, y) {
        ...
        if (
          ...
          if (((m = { values: w ? O : S('values'), keys: g ? O : S('keys'), entries: P }), y))
      ...
      if (y.ABV) {
        ...
        (L = function (t) {
          ...
          (F = function (t, n, e) {
            ...
            if (((e = e === undefined ? r - i : w(e)), i + e > r)) throw A('Wrong length!');
      ...
      t.exports = {
          ...
          return (
            o(s.prototype, {
              ...
              forEach: function (t) {
                d(this, n);
                for (
                  var e, r = u(t, arguments.length > 1 ? arguments[1] : undefined, 3);
                  (e = e ? e.n : this._f);
        ...
        def: function (t, n, e) {
          ...
          return (
            o
              ? (o.v = e)
              : ((t._l = o = { i: (i = p(n, !0)), k: n, v: e, p: (r = t._l), n: undefined, r: !1 }),
                t._f || (t._f = o),
                r && (r.n = o),
                t[v]++,
                'F' !== i && (t._i[i] = o)),
    ...
    function (t, n, e) {
      ...
      t.exports =
        ...
        function (t) {
          ...
          return i < a
            ? s * f(i / a / u) * a * u
            : ((n = (1 + u / o) * i), (e = n - (n - i)), e > c || e != e ? s * Infinity : s * e);
        };
    },
    function (t, n) {
      t.exports =
        ...
        s = (function () {
          ...
          return (
            ...
            (t.prototype.getStateTokenFromLocal = function () {
              var t = void 0;
              return (
                this.useLocalStorage && (t = (0, f.getLocalStorageValue)(this.stateTokenName)),
          ...
          (o.prototype = j.constructor = u),
            ...
            (p.prototype = {
              ...
              delegateYield: function (t, n, e) {
                return (
                  (this.delegate = { iterator: d(t), resultName: n, nextLoc: e }),
    ...
    function (t, n, e) {
      e(211), e(213), e(217), e(212), e(215), e(216), (t.exports = e(32).Promise);
    },
    function (t, n) {
      t.exports = function () {};
    },
        ...
        'Array',
        {
          from: function (t) {
            ...
            if (
              ...
              for (n = a(h.length), e = new p(n); n > y; y++) f(e, y, g ? v(h[y], y) : h[y]);
            else
      ...
      r(
        ...
        'Array',
        {
          slice: function (t, n) {
            var e = c(this.length),
              r = o(this);
            if (((n = n === undefined ? e : n), 'Array' == r)) return a.call(this, t, n);
    ...
    function (t, n, e) {
      var r = e(0),
        ...
        u = Math.acosh;
      r(
        r.S + r.F * !(u && 710 == Math.floor(u(Number.MAX_VALUE)) && u(Infinity) == Infinity),
        'Math',
        {
          acosh: function (t) {
            return (t = +t) < 1
        ...
        return [
          ...
          function (t) {
            ...
            for (var l, h = [], p = 0; null !== (l = u(a, f)); ) {
              var d = String(l[0]);
              (h[p] = d), '' === d && (a.lastIndex = o(f, i(a.lastIndex), s)), p++;
            }
            return 0 === p ? null : h;
          },
        ];
        ...
        return [
          ...
          function (t, n) {
            ...
            for (var S = '', b = 0, w = 0; w < x.length; w++) {
              _ = x[w];
              for (
                var E = String(_[0]), M = f(s(u(_.index), h.length), 0), k = [], O = 1;
                O < _.length;
                O++
              )
                k.push(d(_[O]));
          ...
          (v =
            ...
            ''.split(/.?/)[p]
              ? function (t, n) {
                  ...
                  return (
                    l === i[p] ? (!c && v.test('')) || a.push('') : a.push(i.slice(l)),
                    a[p] > d ? a.slice(0, d) : a
                  );
                }
      ...
      e(3)(function () {
        ...
        ? c(function () {
            ...
            return '/'.concat(
              t.source,
              '/',
              'flags' in t ? t.flags : !o && t instanceof RegExp ? i.call(t) : undefined,
            );
          })
        : 'toString' != u.name &&
          c(function () {
      ...
      var r = e(2),
        ...
        $ = function (t, n, e) {
          return (
            ...
            i(B, n)
              ? (e.enumerable
                  ? (i(t, R) && t[R][n] && (t[R][n] = !1), (e = E(e, { enumerable: w(0, !1) })))
        ...
        J = function (t, n) {
          m(t);
          for (var e, r = g((n = S(n))), i = 0, o = r.length; o > i; ) $(t, (e = r[i++]), n[e]);
          return t;
        },
        X = function (t, n) {
          ...
          return (
            (t.prototype.createButtonElement = function () {
              if (!0 === this.use) {
                ...
                return (
                  (e.src = this.generateImageUrl()), (e.height = this.height), n.appendChild(e), n
                );
              }
              return null;
            }),
        ...
        h = (function () {
          ...
          return (
            (t.prototype.getAccessTokenFromLocal = function () {
              ...
              if (
                ((null != t && t !== undefined) || (t = (0, c.getCookie)(this.accessTokenName)),
                null == t || t === undefined)
              )
                return null;
              ...
              return null == n
                ? null
                : ((null != this.accessToken && this.accessToken.accessToken === n.accessToken) ||
                    (this.accessToken = n),
                  this.accessToken);
            }),
            ...
            (t.prototype.setAccessTokenToLocal = function () {
              return (
                null != this.accessToken &&
                this.accessToken !== undefined &&
                (!!(0, u.setLocalStorageValue)(this.accessTokenName, this.accessToken.toString()) ||
                  (0, c.setCookie)(
        ...
        m = (function () {
          ...
          return (
            ...
            (t.prototype.generateAuthorizeUrl = function () {
              this.generateState();
              var t = 'https://nid.naver.com/oauth2.0/authorize?response_type=code';
              return (
            ...
            (t.prototype.popup = function () {
              var t = this.generateAuthorizeUrl();
              new c['default'](t, '600', '800', null, 'naver_login', null).attachOnclickEvent(
